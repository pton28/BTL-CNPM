   ...
   return (
      <div className="evaluate-appointment-container">
         <div className="question">
            <p>
               Nhìn chung, mức độ hài lòng của bạn đối với Học phần này? /Overall, how satisfied are
               you with tức độ hài lòng của bạn đối với Học phần này? /Overall, how satisfiehis
               course?
            </p>
            {[
               'Rất hài lòng',
