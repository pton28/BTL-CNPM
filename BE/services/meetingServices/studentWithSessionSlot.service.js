...
const studentWithSessionSlotService = {
    createStudentWithSessionSlot: async (studentWithSessionSlotData) => {
        try {
            const { student, session, meeting, slot } = studentWithSessionSlotData;
            ...
            if (existingRecord) {
                if (existingRecord.slot.toString() !== slot.toString()) {
                    ...
                    existingRecord.date_signup = studentWithSessionSlotData.date_signup || new Date();
    ...
    getStudentWithSessionSlotById: async (id) => {
        ...
        updateStudentWithSessionSlot: async (id, updateData) => {
            ...
            deleteStudentWithSessionSlot: async (id) => {
                ...
                getStudentWithSessionSlotByStudentAndMeeting: async (studentId, meetingId) => {
                    try {
                        ...
                        console.log('Error in getStudentWithSessionSlotByStudentAndMeeting', error)
                        return null
                    }
                }
}
